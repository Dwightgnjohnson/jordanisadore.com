				...
				<div class="description-wrapper">
					<h1 class="page-title">
						<?php
							...
							elseif ( is_author() ) :
								printf( __( 'Author: %s', 'jordan' ), '<span class="vcard">' . get_the_author() . '</span>' );

							elseif ( is_day() ) :
								printf( __( 'Day: %s', 'jordan' ), '<span>' . get_the_date() . '</span>' );

							elseif ( is_month() ) :
								printf( __( 'Month: %s', 'jordan' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'jordan' ) ) . '</span>' );

							elseif ( is_year() ) :
								printf( __( 'Year: %s', 'jordan' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'jordan' ) ) . '</span>' );
